...
npm run clean `}),e.add({id:7,href:"/docs/help/faq/",title:"FAQ",description:"FAQ",content:`Hyas? #The theme is a Hyas theme build by the creator of Hyas.
...
Netlify Community Hugo Forums Doks Discussions `}),e.add({id:8,href:"/docs/help/sdmx/",title:"SDMX",description:"About SDMX",content:`Hyas? #SDMX is a Hyas theme build by the creator of Hyas.
Footer notice? #Please keep it in place.
Keyboard shortcuts for search? #focus: Ctrl + / select: ↓ and ↑ open: Enter close: Esc Other documentation? #Netlify Hugo Can I get support? #Create a topic:
Netlify Community Hugo Forums Doks Discussions Contact the creator? #Send h-enk a message:
